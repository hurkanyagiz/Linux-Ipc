...
| [`03_pipe_redirect.c`](src/01_pipe/03_pipe_redirect.c) | Redirect stdout/stderr through a pipe |
...
git clone https://github.com/hurkanyagiz/linux-ipc-guide.git
cd linux-ipc-guide
...
make socket     && ./build/01_tcp_server & sleep 1 && ./build/02_tcp_client
make signal     && ./build/01_basic_handler
...
> **Note on diagrams:** the diagrams and SVG assets in this README are original visuals created for this repository. They are conceptually inspired by Linux IPC models and the chapter structure above, rather than copied from any book figure.
